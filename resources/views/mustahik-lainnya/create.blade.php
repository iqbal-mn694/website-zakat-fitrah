        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('mustahik-lainnya.store') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            <label for="total_beras" class="block text-sm font-medium text-gray-700">Total Beras (kg)</label>
                            <input type="number" step="0.01" name="total_beras" id="total_beras" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                        </div>

                        <div class="mb-4">
                            <label for="total_uang" class="block text-sm font-medium text-gray-700">Total Uang (Rp)</label>
                            <input type="number" name="total_uang" id="total_uang" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                        </div>
